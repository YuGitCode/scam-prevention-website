      ...
      <Fade direction="up" triggerOnce={true}>
        <div className="bg-white rounded-lg shadow-lg max-w-lg w-full p-6 relative">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-bold">{content[currentIndex].id}. {content[currentIndex].title}</h2>
            <button
          ...
          <div className="flex justify-end mt-4 space-x-4">
            ...
            <button
              ...
              onClick={prevContent} disabled={currentIndex === 0}
            >
              Previous
            </button>
            ...
            <button
              className='transition-transform duration-300 transform hover:scale-110 bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded disabled:opacity-50'
              onClick={nextContent} disabled={currentIndex === content.length - 1}
            >
              Next
            </button>
          </div>
