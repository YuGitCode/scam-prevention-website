    ...
    <section className={`${styles.padding} mb-20`}>
      ...
      <div id='content' className={`${styles.margin},${styles.padding} `}>
        ...
        >
          ...
          <Fade delay={300}>
            <div
              className={` text-wrap w-full flex flex-col justify-center `}
            >
              <p className={`text-5xl md:mb-5 xxs:text-3xl xxs:mb-3`}>
                Red Word Cloud - Spam Emails
              </p>
              <span className={`text-2xl xxs:text-md leading-loose xxs:leading-normal font-light mb-10`}>
                This word cloud represents common vocabulary found in phishing
                emails. Words like "free," "prize," and "claim" are used to
                attract the recipient's attention and provoke curiosity or greed,
                encouraging them to click on links or divulge personal
                information. The language is direct and often conveys a sense of
                urgency with terms like "urgent," "reply," and "stop," aiming to
                prompt immediate action. There is also a frequent mention of money
                or rewards, such as "cash" and "award," intended to lure
        ...
        >
          ...
          <Fade delay={300}>
            <div className={` text-wrap w-full flex flex-col justify-center`}>
              ...
              >
                This word cloud illustrates the typical language used in everyday
                emails or messages. It features conversational words such as
                "love," "time," and "good," reflecting natural and fluid
                communication that maintains personal relationships. The style is
                more relaxed, with a focus on everyday life details and emotional
                expression, using phrases like "thank you," "happy," and "dear."
                This showcases more genuine and intimate interpersonal
                interactions, in contrast to the manipulative nature of spam
                emails.
              </span>
            </div>
          </Fade>
